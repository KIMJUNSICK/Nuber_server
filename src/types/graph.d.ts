...
export interface Mutaition {
  SendChatMessage: SendChatMessageResponse;
}

export interface SendChatMessageMutaitionArgs {
  text: string;
  chatId: number;
}
